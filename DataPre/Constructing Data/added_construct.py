...
import numpy as np
import tqdm
first1 = pd.read_csv('/Users/duanjingyuan/Documents/Fintech80 2021/data analysis/Constructing Data/constructed1.csv',low_memory=False)
first2 = pd.read_csv('/Users/duanjingyuan/Documents/Fintech80 2021/data analysis/Constructing Data/constructed2.csv',low_memory=False)
...
def process_data(dataset):
    ...
    data['Unpaid'] = data['Unpaid'].fillna(0)
    return data
...
final_cleaned1 = d_data1[d_columns]
final_cleaned2 = d_data2[d_columns]
final_cleaned1.to_csv('/Users/duanjingyuan/Documents/Fintech80 2021/data analysis/final_constructed1.csv',index=False)
final_cleaned2.to_csv('/Users/duanjingyuan/Documents/Fintech80 2021/data analysis/final_constructed2.csv',index=False)