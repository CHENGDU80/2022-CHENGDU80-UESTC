...
modify_data = pd.read_csv('/Users/duanjingyuan/Documents/Fintech80 2021/data analysis/Constructing Data/company/stocking_modify.csv')
inv_data = new_data[['entid','CONAM_new','CONPROP_new','ttype']]
stocking_inv = pd.merge(modify_data,inv_data,on='entid',how='left')
stocking_inv.to_csv('stocking_inv.csv',index=False)
label_modify = pd.read_csv('/Users/duanjingyuan/Documents/Fintech80 2021/data analysis/Constructing Data/company/label_modify.csv')
label_inv = pd.merge(label_modify,inv_data,on='entid',how='left')
label_inv.to_csv('label_inv.csv',index=False)