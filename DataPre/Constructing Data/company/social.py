...
cleaned1 = pd.read_csv('/Users/duanjingyuan/Documents/Fintech80 2021/data analysis/Constructing Data/tax/year_abnormal.csv',low_memory=False)
cleaned2 = pd.read_csv('/Users/duanjingyuan/Documents/Fintech80 2021/data analysis/Constructing Data/tax/label_abnormal.csv',low_memory=False)
added1 = pd.merge(cleaned1,social,on='entid',how='left')
added2 = pd.merge(cleaned2,social,on='entid',how='left')
added1.to_csv('/Users/duanjingyuan/Documents/Fintech80 2021/data analysis/Constructing Data/constructed1.csv',index=False)
added2.to_csv('/Users/duanjingyuan/Documents/Fintech80 2021/data analysis/Constructing Data/constructed2.csv',index=False)